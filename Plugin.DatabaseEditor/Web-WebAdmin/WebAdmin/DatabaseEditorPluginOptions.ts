namespace VRS.WebAdmin.DatabaseEditorPluginOptions
{
    import ViewJson = VirtualRadar.Plugin.DatabaseEditor.WebAdmin;
    ...
    export class PageHandler
    {
        ...
        {
            this._ViewId = new ViewId('DatabaseEditorPluginOptions', viewId);
            this.refreshState();
        }
