...
(function (VRS) {
    var WebAdmin;
    (function (WebAdmin) {
        var DatabaseEditorPluginOptions;
        (function (DatabaseEditorPluginOptions) {
            var PageHandler = (function () {
                function PageHandler(viewId) {
                    this._AccessEditor = new WebAdmin.AccessEditor();
                    this._ViewId = new WebAdmin.ViewId('DatabaseEditorPluginOptions', viewId);
                    this.refreshState();
                }
...
//# sourceMappingURL=DatabaseEditorPluginOptions.js.map