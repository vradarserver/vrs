namespace VRS.WebAdmin.FeedFilterPluginOptions
{
    import ViewJson = VirtualRadar.Plugin.FeedFilter.WebAdmin;
    ...
    export class PageHandler
    {
        ...
        {
            this._ViewId = new ViewId('FeedFilterPluginOptions', viewId);
            this.refreshState();
        }
