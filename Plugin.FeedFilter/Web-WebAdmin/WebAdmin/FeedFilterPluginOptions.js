...
(function (VRS) {
    var WebAdmin;
    (function (WebAdmin) {
        var FeedFilterPluginOptions;
        (function (FeedFilterPluginOptions) {
            var PageHandler = (function () {
                function PageHandler(viewId) {
                    this._AccessEditor = new WebAdmin.AccessEditor();
                    this._ViewId = new WebAdmin.ViewId('FeedFilterPluginOptions', viewId);
                    this.refreshState();
                }
            ...
            FeedFilterPluginOptions.PageHandler = PageHandler;
        })(FeedFilterPluginOptions = WebAdmin.FeedFilterPluginOptions || (WebAdmin.FeedFilterPluginOptions = {}));
    })(WebAdmin = VRS.WebAdmin || (VRS.WebAdmin = {}));
})(VRS || (VRS = {}));
//# sourceMappingURL=FeedFilterPluginOptions.js.map