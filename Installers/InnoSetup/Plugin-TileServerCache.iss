...
MinVersion=6.1.7601
OutputBaseFileName=Plugin-Windows-TileServerCache-{#VERSION}
...
; Application files
Source: "{#Root}\Plugin.TileServerCache\bin\Release\VirtualRadar.Plugin.TileServerCache.dll"; DestDir: "{#Plugin}"; Flags: ignoreversion;
