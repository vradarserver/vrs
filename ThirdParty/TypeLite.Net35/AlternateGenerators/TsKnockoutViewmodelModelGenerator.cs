...
namespace TypeLite.AlternateGenerators
{
    ...
    /// <summary>
    /// Generator implementation converting member types to KnockoutObservable<T> and KnockoutViewModelArray<T>
    /// </summary>
    public class TsKnockoutViewmodelModelGenerator : TsGenerator
    {
        /// <summary>
        /// 
        /// </summary>
